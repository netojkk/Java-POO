...
public class Luta {
        ...
        if (aprovada) {
            ...
            for (int i = 1; i <= rounds; i++) {
                ...
                if (desafianteInicia) {
                    ...
                    // chama um metodo para calcular o dano, recebe atributos como a forca do
                    ...
                    if (dadoAtaque == 6) {
                        System.out.println(this.getDesafiante().getName() + " acerta um crítico de " + danoDesafiante);
                    ...
                    if (dadoAtaque == 6) {
                        System.out.println(this.getDesafiado().getName() + " acerta um crítico de " + danoDesafiado);
    ...
    private int dano(int forAtacante, int defDefensor, int dado) {
        ...
        // Dano padrao
        int danoBase = (int) Math.max(0, (forAtacante) - (defDefensor * 0.8));
        ...
        switch (dado) {
            case 6:
                ...
                return (int) Math.max(0, danoBase * 3.5);
            ...
            case 2:
                ...
                return (int) Math.max(0, danoBase * 1);

            case 1:
                System.out.println("Que chance disperdiçada...");
                return (int) Math.max(0, danoBase * 0.95);
        }
        return danoBase;
